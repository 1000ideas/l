...
Gem::Specification.new do |s|
  ...
  s.files = [
    "Rakefile",
    "app/controllers/l/admin/admin_controller.rb",
    "app/controllers/l/admin/galleries_controller.rb",
    "app/controllers/l/admin/gallery_photos_controller.rb",
    "app/controllers/l/admin/news_controller.rb",
    "app/controllers/l/admin/newsletter_mails_controller.rb",
    "app/controllers/l/admin/pages_controller.rb",
    "app/controllers/l/admin/users_controller.rb",
    ...
    "app/views/l/admin/galleries/_edit_form.erb",
    "app/views/l/admin/galleries/_form.html.erb",
    "app/views/l/admin/galleries/_gallery_item.html.erb",
    "app/views/l/admin/galleries/_submenu.erb",
    "app/views/l/admin/galleries/_tooltip.html.erb",
    "app/views/l/admin/galleries/edit.html.erb",
    "app/views/l/admin/galleries/index.html.erb",
    "app/views/l/admin/galleries/new.html.erb",
    "app/views/l/admin/gallery_photos/_show_photos.erb",
    "app/views/l/admin/gallery_photos/create.js.erb",
    "app/views/l/admin/gallery_photos/destroy.js.erb",
    "app/views/l/admin/news/_edit_form.erb",
    "app/views/l/admin/news/_form.html.erb",
    "app/views/l/admin/news/_submenu.erb",
    "app/views/l/admin/news/_tooltip.html.erb",
    "app/views/l/admin/news/destroy.js.coffee",
    "app/views/l/admin/news/edit.html.erb",
    "app/views/l/admin/news/index.html.erb",
    "app/views/l/admin/news/new.html.erb",
    "app/views/l/admin/newsletter_mails/_form.html.erb",
    "app/views/l/admin/newsletter_mails/_submenu.erb",
    "app/views/l/admin/newsletter_mails/_tooltip.html.erb",
    "app/views/l/admin/newsletter_mails/index.html.erb",
    "app/views/l/admin/newsletter_mails/send_mail.html.erb",
    "app/views/l/admin/pages/_edit_form.erb",
    "app/views/l/admin/pages/_form.html.erb",
    "app/views/l/admin/pages/_page_list_item.html.erb",
    "app/views/l/admin/pages/_submenu.erb",
    "app/views/l/admin/pages/_tooltip.html.erb",
    "app/views/l/admin/pages/edit.html.erb",
    "app/views/l/admin/pages/index.html.erb",
    "app/views/l/admin/pages/new.html.erb",
    "app/views/l/admin/users/_filter.html.erb",
    "app/views/l/admin/users/_form.html.erb",
    "app/views/l/admin/users/_submenu.erb",
    "app/views/l/admin/users/_tooltip.html.erb",
    "app/views/l/admin/users/destroy.js.coffee",
    "app/views/l/admin/users/edit.html.erb",
    "app/views/l/admin/users/index.html.erb",
    "app/views/l/admin/users/new.html.erb",
    "app/views/l/admin/users/show.html.erb",
    ...
    "app/views/layouts/l/admin.html.erb",
    "app/views/layouts/l/facebook.html.erb",
    "app/views/layouts/l/mobile.html.erb",
    "app/views/layouts/l/standard.html.erb",
    ...
    "lib/generators/l/l/templates/views/devise/registrations/_submenu.html.erb",
    ...
    "vendor/assets/stylesheets/admin/login.scss",
